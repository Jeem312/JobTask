...
import { Autoplay, Pagination } from "swiper"; // Correct import
...
const testimonials = [
  ...
  },
  {
    ...
    feedback:
      "Ensure your portfolio design is clean and responsive with consistent typography and a cohesive color palette. Include smooth transitions and animations.",
  },
];
  ...
  return (
    <div className="py-10 px-6">
      ...
      <div className="flex gap-2 justify-center items-center mx-auto mt-10">
        <div className="bg-[#D9D9D9] rounded-lg p-1 w-10"></div>
        <div className="bg-[#FD6F00] rounded-lg p-1 w-10"></div>
        <div className="bg-[#D9D9D9] rounded-lg p-1 w-10"></div>
      </div>
    </div>
  );
